...
public class UIManager : MonoBehaviour
{
    ...
    // Mengganti referensi playerController dengan controlPlayer dari GameManager
    ...
    private void FadeFromBlack()
    {
        ...
        {
            // Menggunakan controlPlayer dari GameManager untuk memeriksa mode kontrol
            if (controlPlayer.controlmode == ControlMode.Mobile)
            {
